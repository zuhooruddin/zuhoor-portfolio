...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-[rgba(var(--surface-rgb),0.05)] px-6 pt-14 pb-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-muted)] mb-2">zuhooruddin055@gmail.com</p>
            <p className="text-sm text-[var(--text-muted)] mb-5">Available for remote work</p>
              ...
              {socialLinks.map((link) => {
                ...
                return (
                  <motion.a
                    ...
                    className={`w-9 h-9 rounded-lg glass border border-[rgba(var(--surface-rgb),0.08)] flex items-center justify-center text-[var(--text-muted)] ${link.color} transition-all duration-200`}
                  >
                    <Icon size={15} />
                  </motion.a>
                );
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-[rgba(var(--surface-rgb),0.08)] to-transparent mb-8" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-9 h-9 rounded-lg glass border border-[rgba(var(--surface-rgb),0.08)] flex items-center justify-center text-[var(--text-muted)] hover:text-teal-400 transition-colors"
